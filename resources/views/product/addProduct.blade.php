...
<div class="container-fluid mt-3">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('addProduct')}}" method="POST" id="addProductForm" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4 mt-sm-0 mt-4">
                        ...
                        <input type="text" class="form-control" name="title" id="title" placeholder="Enter Product's Title">
                        @if ($errors->has('title'))
                ...
                <div class="row mb-3">
                    <div class="col-sm-4">
                        ...
                        <textarea class="form-control" name="description" id="description" rows="1" placeholder="Enter Product's Description"></textarea>
                    ...
                    <div class="col-sm-4 mt-sm-0 mt-4">
                        ...
                        <input type="text" class="form-control" name="base_price" id="base_price" placeholder="Enter Product's Base Price">
                    ...
                    <div class="col-sm-4 mt-sm-0 mt-4">
                        ...
                        <input type="text" class="form-control" name="disc_price" id="disc_price" placeholder="Enter Product's Discounted Price">
