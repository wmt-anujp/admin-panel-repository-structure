...
class ProductsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($query) {
                $editUrl = route('getEditProduct', $query->id);
                ...
                <a href="#" onclick="deleteProduct(' . "'" . $query->id . "'" . ')" class="btn btn-sm btn-danger"><i class="bi bi-x-circle-fill mr-2"></i> Delete</a>
                </div></center>';
            })
    ...
    public function query(Product $model)
    {
        ...
        return $this->applyScopes($product);
    }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->minifiedAjax(route('getProducts'))
            ->orderBy(1)
            ->responsive(true)
            ->autoWidth(100)
            ->selectStyleSingle()
